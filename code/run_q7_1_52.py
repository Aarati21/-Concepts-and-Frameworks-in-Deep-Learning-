# -*- coding: utf-8 -*-
"""
Created on Sun Nov 17 19:06:15 2019
...
class ConvNet(torch.nn.Module):
    ...
    def __init__(self, num_classes):
        ...
        self.residual_block_1 = ResidualBlock(channels=[1, 10, 20])
        self.residual_block_2 = ResidualBlock(channels=[20, 40, 60])
    
        self.linear_1 = torch.nn.Linear(60*8*8, num_classes)
    ...
    def forward(self, x):
        ...
        logits = self.linear_1(out2.view(-1, 60*8*8))
...
def main():
    ...
    plt.legend()
    plt.savefig('../Results/7152_loss.png')
    plt.show()
    ...
    plt.legend()
    plt.savefig('../Results/7152_acc.png')
    plt.show()
